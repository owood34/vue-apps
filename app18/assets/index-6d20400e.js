...
const HomeView_vue_vue_type_style_index_0_scoped_8b662f5d_lang = "";
...
const _withScopeId = (n) => (pushScopeId("data-v-8b662f5d"), n = n(), popScopeId(), n);
const _hoisted_1$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, " Hello! It's party time!", -1));
const _hoisted_2$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("hr", null, null, -1));
const _sfc_main$1 = {
  __name: "HomeView",
  setup(__props) {
    let router2 = useRouter();
    let colors = useMenuStore().skin;
    document.body.style.setProperty("--style", "white");
    function login() {
      changeColor();
    }
    function changeColor() {
      let counter = 0;
      setInterval(() => {
        document.body.style.setProperty("--style", colors[counter % colors.length]);
        counter++;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", null, [
        _hoisted_1$1,
        _hoisted_2$1,
        createBaseVNode("button", { onClick: login }, " Click for a party! ")
      ]);
    };
  }
};
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8b662f5d"]]);
const _imports_0 = "/app18/assets/ballons-671242fe.png";
const _imports_1 = "/app18/assets/banner-9dd0f5a0.png";
const _imports_2 = "/app18/assets/table-de04d8b5.png";
const _imports_3 = "/app18/assets/presents-7aa7b755.png";
const LoginView_vue_vue_type_style_index_0_lang = "";
...
const _hoisted_7 = /* @__PURE__ */ createStaticVNode('<h3> But first you gotta dress for the occasion! </h3><img src="' + _imports_0 + '" style="top:100px;right:100px;width:300px;height:300px;"><img src="' + _imports_0 + '" style="top:300px;right:600px;width:200px;height:200px;"><img src="' + _imports_1 + '" style="top:-80px;left:700px;width:800px;height:400px;"><img src="' + _imports_2 + '" style="top:300px;left:700px;width:400px;height:400px;"><img src="' + _imports_0 + '" style="top:300px;left:500px;width:200px;height:200px;"><img src="' + _imports_3 + '" style="top:200px;right:60px;width:600px;height:600px;">', 7);
const _sfc_main = {
  __name: "LoginView",
  setup(__props) {
    const width = 400;
    ...
    function createStickman() {
      ...
      const svg = d3.select("#app").append("svg").lower().attr("width", width).attr("height", height);
      svg.append("circle").attr("id", "head").attr("cx", 100).attr("cy", 140).attr("r", 50).style("fill", "white").style("stroke", store.skin.value.charAt(0) + store.skin.value.slice(1)).style("stroke-width", useMenuStore().functions.body);
      svg.append("line").attr("id", "body").attr("x1", 100).attr("y1", 190).attr("x2", 100).attr("y2", 340).style("stroke", store.skin.value.charAt(0) + store.skin.value.slice(1)).style("stroke-width", useMenuStore().functions.body);
      svg.append("line").attr("id", "arm1").attr("x1", 100).attr("y1", 190).attr("x2", 150).attr("y2", 315).style("stroke", store.skin.value.charAt(0) + store.skin.value.slice(1)).style("stroke-width", useMenuStore().functions.body);
      svg.append("line").attr("id", "arm2").attr("x1", 100).attr("y1", 190).attr("x2", 50).attr("y2", 315).style("stroke", store.skin.value.charAt(0) + store.skin.value.slice(1)).style("stroke-width", useMenuStore().functions.body);
      svg.append("line").attr("id", "leg1").attr("x1", 100).attr("y1", 340).attr("x2", 120).attr("y2", 490).style("stroke", store.skin.value.charAt(0) + store.skin.value.slice(1)).style("stroke-width", useMenuStore().functions.body);
      svg.append("line").attr("id", "leg2").attr("x1", 100).attr("y1", 340).attr("x2", 80).attr("y2", 490).style("stroke", store.skin.value.charAt(0) + store.skin.value.slice(1)).style("stroke-width", useMenuStore().functions.body);
    }
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("main", null, [
          createBaseVNode("nav", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(store), (i) => {
              return openBlock(), createElementBlock("div", { key: i }, [
                createBaseVNode("h1", null, toDisplayString(i.name), 1),
                createBaseVNode("button", {
                  type: "button",
                  onClick: ($event) => change(i.name)
                }, toDisplayString(i.value), 9, _hoisted_1)
              ]);
            }), 128))
          ])
        ]),
        ...
        createBaseVNode("img", {
          src: getTorso(),
          style: { "top": "195px", "left": "60px", "height": "150px" }
        }, null, 8, _hoisted_4),
        createBaseVNode("img", {
          src: getPants(),
          style: { "top": "310px", "left": "60px", "height": "150px" }
        }, null, 8, _hoisted_5),
        createBaseVNode("img", {
          src: getShoes(),
          style: { "top": "440px", "left": "50px" }
        }, null, 8, _hoisted_6),
        _hoisted_7
      ]);
    };
...
const router = createRouter({
  history: createWebHistory("/app18/"),
  routes: [
    {
      path: "/",
      name: "home",
